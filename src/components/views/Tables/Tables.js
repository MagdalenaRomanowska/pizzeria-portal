...
const Tables = () => (
  <div className={styles.component}>
    <h2>Tables view</h2>
    <Link to={`${process.env.PUBLIC_URL}/tables/bookings/new`} className={styles.list} activeclassname='active'>New booking</Link><br></br>
    ...
    <Link to={`${process.env.PUBLIC_URL}/tables/events/new`} className={styles.list} activeclassname='active'>New event</Link><br></br>
